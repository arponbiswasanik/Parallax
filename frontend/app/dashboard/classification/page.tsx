  ...
  return (
    <div style={{ background: '#080a0f', minHeight: '100vh', padding: '72px 56px', fontFamily: 'var(--font-sora), sans-serif' }}>
      ...
      <div style={{ marginBottom: '64px' }}>
        ...
        <h1 style={{ fontSize: '40px', fontWeight: 600, color: '#ffffff', letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: '12px' }}>Fraud Detection</h1>
      ...
      {/* Chart */}
      <div>
        <p style={{ fontSize: '12px', color: '#d1d5db', letterSpacing: '0.08em', textTransform: 'uppercase', fontWeight: 500, marginBottom: '32px' }}>Drift Metrics Over Time</p>
        <ResponsiveContainer width="100%" height={320}>
          <AreaChart data={data}>
            ...
            <Area type="monotone" dataKey="js_divergence" stroke="#22d3ee" fill="url(#jsGrad)" strokeWidth={1.5} dot={false} />
            <Area type="monotone" dataKey="ks_statistic" stroke="#f59e0b" fill="url(#ksGrad)" strokeWidth={1.5} dot={false} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
