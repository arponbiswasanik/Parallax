  ...
  return (
    <div style={{ background: bg, minHeight: '100vh', padding: '72px 56px', fontFamily: 'var(--font-sora), sans-serif' }}>
      ...
      <div style={{ marginBottom: '64px' }}>
        ...
        <h1 style={{ fontSize: '40px', fontWeight: 600, color: textPrimary, letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: '12px' }}>Energy Consumption</h1>
      ...
      {/* Chart */}
      <div>
        <p style={{ fontSize: '12px', color: textMuted, letterSpacing: '0.08em', textTransform: 'uppercase', fontWeight: 500, marginBottom: '32px' }}>Regression Drift Over Time</p>
